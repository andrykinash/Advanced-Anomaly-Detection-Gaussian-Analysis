...
for test_file_name in test_file_names:
    ...
    # Normalize and calculate PDF values
    normalized_test_df = normalize_data(test_data[features_to_use], mean, std)
    pdf_values = calculate_pdf(normalized_test_df, mean, std)
    ...
    predicted_label = 1 if abnormal_percentage > 32 else 0  # Customize the threshold as needed
